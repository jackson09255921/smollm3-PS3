...
MODEL_NAME="HuggingFaceTB/SmolVLM-500M-Instruct" # <--- 基礎 LLM (500M)
DATA_PATH="scripts/mixtures/onevision_no_mammoth_more_image_balanced.yaml" # <--- 檢查你的資料路徑
DATA_FOLDER="/path/to/user/apollo-dataset/" # <--- 檢查你的資料路徑
RUN_NAME="ps3-500m-visionunfrozen-newmix" # <--- 新的實驗名稱
